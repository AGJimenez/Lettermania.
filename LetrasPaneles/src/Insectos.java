...
public class Insectos extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Insectos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Insectos(arbol).setVisible(true);
            }
        });
    }
...
class Fondo extends JPanel{
    ...
    public void paint(Graphics g){
        imagenFondo = new ImageIcon(getClass().getResource("bicho.png")).getImage();
...
class ImagenPanel extends JPanel{
    ...
    @Override
    public void paint(Graphics g){
        imagen = new ImageIcon(getClass().getResource("bichopanel.png")).getImage();
