...
public class Minerales extends javax.swing.JFrame {
    ...
    public Minerales(Paises paises) {
        initComponents();
        ...
        value = paises.getValue();
        tiempo = paises.getTiempo();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Minerales(paises).setVisible(true);
            }
        });
    }
    ...
    class Fondo extends JPanel {
        ...
        public void paint(Graphics g) {
            imagenFondo = new ImageIcon(getClass().getResource("minafondo.png")).getImage();
    ...
    class ImagenPanel extends JPanel {
        ...
        @Override
        public void paint(Graphics g) {
            imagen = new ImageIcon(getClass().getResource("paneloro.png")).getImage();
