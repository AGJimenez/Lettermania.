...
public class Paises extends javax.swing.JFrame {
    ...
    public Paises(Dioses dioses) {
        ...
        this.setLocationRelativeTo(this);
          ...
          value=dioses.getValue(); 
          tiempo=dioses.getTiempo();
    ...
    private void initComponents() {
        ...
        jLabel38.setText("PAISES AFRICANOS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        case "zambia":
            ...
            jLabel33.setBackground(Color.green);
            jLabel34.setBackground(Color.green);
        ...
        default:
            ...
            jTextField1.setText("");
            dioses.contadornegativo--;
            if(dioses.contadornegativo==1){
                SeleccionPuntuacion finJuego = new SeleccionPuntuacion();
                finJuego.setVisible(true);
        ...
        if (contador==3){
            ...
            Minerales lvl10 = new Minerales(this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Paises(dioses).setVisible(true);
            }
        });
    }
...
class Fondo extends JPanel{
    ...
    public void paint(Graphics g){
        imagenFondo = new ImageIcon(getClass().getResource("fondoafrica.png")).getImage();
...
class ImagenPanel extends JPanel{
    ...
    @Override
    public void paint(Graphics g){
        imagen = new ImageIcon(getClass().getResource("africapanel.png")).getImage();
