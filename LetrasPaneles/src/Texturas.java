...
public class Texturas extends javax.swing.JFrame {
    ...
    //atributos
    int contador=0;
    private Colores puntos = new Colores();
    private Fuentes tipoFuente;
    private Fondo a = new Fondo();
    private ImagenPanel b = new ImagenPanel();
    private Integer value; 
    private Integer tiempo;
    static Colores colores;
    
    public Texturas(Colores colores) {
        setContentPane(a);
        setContentPane(b);
        initComponents();
        ...
        this.setLocationRelativeTo(this);
          ...
          value=colores.getValue(); 
          tiempo=colores.getTiempo();
    ...
    private void initComponents() {
        ...
        puntosEtiqueta2 = new javax.swing.JLabel();
        ...
        puntosEtiqueta2.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        puntosEtiqueta2.setForeground(new java.awt.Color(204, 0, 204));
        puntosEtiqueta2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        puntosEtiqueta2.setText("0");
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGap(25, 25, 25)
                .addComponent(puntosEtiqueta2, javax.swing.GroupLayout.PREFERRED_SIZE, 45, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(30, Short.MAX_VALUE))
        );
        jPanel7Layout.setVerticalGroup(
            jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(puntosEtiqueta2, javax.swing.GroupLayout.DEFAULT_SIZE, 34, Short.MAX_VALUE)
        );
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jPanel6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 247, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public void setPunt(int punt) {
        puntosEtiqueta2.setText(Integer.toString(punt));
    }
    
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String respuesta = jTextField1.getText();
        
        int punt = Integer.parseInt(puntosEtiqueta2.getText());
        ...
        if (contador==3){
            ...
            Musica lvl3 = new Musica(this);
            lvl3.setVisible(true);
            lvl3.setPunt(punt); // Pasar el valor de punt a Musica
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Texturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Texturas(colores).setVisible(true);
            }
        });
    }

    private int getPunt() {
        return puntos.getPunt();
    }
...
class Fondo extends JPanel{
    ...
    public void paint(Graphics g){
        imagenFondo = new ImageIcon(getClass().getResource("fondTxt.png")).getImage();
...
class ImagenPanel extends JPanel{
    ...
    @Override
    public void paint(Graphics g){
        imagen = new ImageIcon(getClass().getResource("panelTexturas.png")).getImage();
    ...
    private javax.swing.JLabel puntosEtiqueta2;
