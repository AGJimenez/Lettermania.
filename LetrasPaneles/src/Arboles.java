...
public class Arboles extends javax.swing.JFrame {
    ...
    static Huesos huesos;
    
    public Arboles(Huesos huesos) {
        ...
        this.setLocationRelativeTo(this);
          ...
          value=huesos.getValue(); 
          tiempo=huesos.getTiempo();
    ...
    private void initComponents() {
        ...
        jLabel38.setText("ÁRBOLES MEDITERRÁNEOS");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String [] soluciones= {"encina", "pino", "roble"};
        ...
        if (contador==3){
            ...
            Insectos lvl7 = new Insectos(this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Arboles(huesos).setVisible(true);
            }
        });
    }
...
class Fondo extends JPanel{
    ...
    public void paint(Graphics g){
        imagenFondo = new ImageIcon(getClass().getResource("arbolesfondo.png")).getImage();
...
class ImagenPanel extends JPanel{
    ...
    @Override
    public void paint(Graphics g){
        imagen = new ImageIcon(getClass().getResource("panelarbol.png")).getImage();
