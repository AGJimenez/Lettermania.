...
public class Musica extends javax.swing.JFrame {
    ...
    ImagenPanel music = new ImagenPanel();
    private Integer value; 
    private Integer tiempo;
    static Texturas textura;
    
    public Musica(Texturas textura) {
        ...
        this.setLocationRelativeTo(this);
         ...
         value=textura.getValue(); 
          tiempo=textura.getTiempo();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String [] soluciones= {"Compas", "Nota", "Sol"};
        ...
        if (contador==3){
            ...
            SeleccionPuntuacion finJuego = new SeleccionPuntuacion();
            finJuego.setVisible(true);
            finJuego.setjLabel1("ENHORABUENA, HAS GANADO");
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Musica(textura).setVisible(true);
            }
        });
    }
...
class Fondo extends JPanel{
    ...
    public void paint(Graphics g){
        imagenFondo = new ImageIcon(getClass().getResource("concert.png")).getImage();
...
class ImagenPanel extends JPanel{
    ...
    @Override
    public void paint(Graphics g){
        imagen = new ImageIcon(getClass().getResource("panel.png")).getImage();
